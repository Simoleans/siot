...
class PlantasController extends Controller
{
	...
	*/
	...
	public function accessRules()
    {
        ...
        {
             $arr =array('index','view','create','update','admin', 'delete', 'SelectMunicipio','SelectParroquia');   // give all access to admin
        }
		else 
			if( Yii::app()->user->getState('roles') =="2")
                {
                        $arr =array('index','view', 'create', 'update','admin', 'delete', 'SelectMunicipio','SelectParroquia');   // give all access to staff
                }
                else
                {
