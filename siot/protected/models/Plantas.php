...
class Plantas extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('cap_inst', 'numerical', 'min'=>5),
			array('cap_ope', 'numerical', 'min'=>10),
			array('cap_alm', 'numerical', 'min'=>30),
			array('alm_frio, alm_seco, alm_silo', 'numerical', 'min'=>100),
			array('cant_empleados', 'numerical', 'min'=>10),
			...
			array('descripcion, cap_inst, cap_ope, cap_alm, alm_seco, alm_frio, alm_silo, cant_lineas, estatus_lineas, cant_empleados, longitud, latitud, activo', 'required')
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'cap_inst' => 'Capacidad Instalada (Tn)',
			'cap_ope' => 'Capacidad Operativa (Tn)',
			'cap_alm' => 'Capacidad de Almacenamiento (Tn)',
			'alm_seco' => 'Almacenamiento en Seco (Tn)',
			'alm_frio' => 'Almacenamiento en Frio (Tn)',
			'alm_silo' => 'Almacenamiento en Silo (Tn)',
