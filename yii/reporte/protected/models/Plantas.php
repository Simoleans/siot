...
class Plantas extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('tipo_id, estado_id, municipio_id, parroquia_id, cap_inst, cap_ope, cap_alm, alm_seco, alm_frio, alm_silo, cant_lineas, estatus_lineas, cant_empleados, activo', 'numerical', 'integerOnly'=>true),
