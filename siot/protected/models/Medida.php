...
class Medida extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre_medida', 'required'),
			array('abv_medida', 'required'),
			array('nombre_medida', 'length', 'max'=>100),
			array('abv_medida', 'length', 'max'=>5),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_medida, nombre_medida, abv_medida', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nombre_medida',$this->nombre_medida,true);
		$criteria->compare('abv_medida',$this->abv_medida,true);
