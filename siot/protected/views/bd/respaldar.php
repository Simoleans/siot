...
$usuario="u592676519_siot";
$passwd="siot45";
$host="mysql.hostinger.es";
$bd="u592676519_siot";
$nombre="siot".date("Y/m/d").".sql"; //Este es el nombre del archivo a generar
...
/*ob_start();*/ //Imprimi todo lo que esta cargando (imprime html de la pagina)
print_r($tablas);
