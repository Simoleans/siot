...
class TipoPlantaController extends Controller
{
	...
	*/
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['TipoPlanta'];
			if($model->save())
	...
	{
		$model=new TipoPlanta('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TipoPlanta']))
			$model->attributes=$_GET['TipoPlanta'];
	...
	{
		$model=TipoPlanta::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param TipoPlanta $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipo-planta-form')
		{
